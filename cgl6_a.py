...
if __name__ == '__main__':
    ...
    for i in range(n):
        ...
        if a == c:
            EP.append(EndPoint(Vector2(a, min(b, d)), i, 0))
            EP.append(EndPoint(Vector2(a, max(b, d)), i, 3))
            S.append([Vector2(a, max(b, d)), Vector2(a, min(b, d))])
        else:
            EP.append(EndPoint(Vector2(min(a, c), b), i, 1))
            EP.append(EndPoint(Vector2(max(a, c), b), i, 2))
